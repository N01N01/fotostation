                    ...
                    <table class="table table-bordered table-striped table-hover js-dataTable dataTable mb0">
                        <thead>
                            <tr>
                                ...
                                <th><?=l('Maximum groups')?></th> 
                                <th><?=l('Maximum pages')?></th> 
                                <th><?=l('Maximum liked pages')?></th> 
                                <th><?=l('Day')?></th>
                                <th><?=l('Default')?></th>
                                <th><?=l('Status')?></th>
                                <th><?=l('Option')?></th>
                        ...
                        <tbody>
                            ...
                            <tr class="pending" data-action="<?=cn('ajax_action_item')?>" data-id="<?=$row->id?>">
                                ...
                                <td><?=$row->name?></td>
                                <td><?=$permission->maximum_account?></td>
                                <td><?=$permission->maximum_groups?></td>
                                <td><?=$permission->maximum_pages?></td>
                                <td><?=$permission->maximum_liked_pages?></td>
                                <td><?=$row->day?></td>
                                <td><?=$row->default_package?></td>
                                <td style="width: 60px;">
                                    <div class="switch">
