            ...
            <div class="body">
                <div class="row">
                    <div class="col-sm-12 mb0">
                        <ul class="list-group">
                            <li class="list-group-item"><?=l('Maximum facebook accounts')?><span class="badge bg-blue"><?=!empty($result)?$result->maximum_account:0?></span></li>
                            <li class="list-group-item"><?=l('Maximum groups')?><span class="badge bg-blue"><?=!empty($result)?$result->maximum_groups:0?></span></li>
                            <li class="list-group-item"><?=l('Maximum pages')?><span class="badge bg-blue"><?=!empty($result)?$result->maximum_pages:0?></span></li>
                            <li class="list-group-item"><?=l('Maximum liked pages')?><span class="badge bg-blue"><?=!empty($result)?$result->maximum_liked_pages:0?></span></li>
